        ...
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" id="search_phone" name="search_phone" class="form-control form-control-solid w-250px ps-14" placeholder="Утасны дугаар" />
                </div>
                ...
                <div class="d-flex align-items-center position-relative my-1 mx-3">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" id="search_email" name="search_email" class="form-control form-control-solid w-250px ps-14" placeholder="И-мэйл" />
                </div>
                <!--end::Search-->
            </div>
        </div>
...
@section('scripts')
    <script>
        var subscriptions_table  = $("#subscriptions").DataTable({
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        return '<a class="text-gray-800 text-hover-primary mb-1" href="/subscription/view/'+full.id+'">'+full.plan.name + '</a>';
                    }
                },
                {
                    targets:2,
        ...
        $('#search_phone, #search_email').change(function() {
