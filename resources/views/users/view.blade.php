    ...
    <div class="d-flex flex-column flex-xl-row">
                ...
                <div class="card-body pt-0 pt-lg-1">
                    ...
                    <div class="d-flex flex-stack fs-4 py-3">
                        ...
                        <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Edit customer details">
                            <a href="#" class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_update_details">Засах</a>
                        </span>
                    </div>
                    <!--end::Details toggle-->
        ...
        <div class="flex-lg-row-fluid ms-lg-15">
            ...
            <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-8">
                ...
                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_user_view_overview_roles_and_permissions">Системийн эрх</a>
                </li>
            ...
            <div class="tab-content" id="myTabContent">
                                ...
                                <table class="table align-middle table-row-dashed fw-bold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <!--end::Badge=-->
                                            <!--begin::Status=-->
                                            <td>POST /v1/invoice/in_6962_1094/invalid</td>
                                            <!--end::Status=-->
                                            <!--begin::Timestamp=-->
                                            <td class="pe-0 text-end min-w-200px">24 Jun 2021, 8:43 pm</td>
                                            <!--end::Timestamp=-->
                                        </tr>
                                        <!--end::Table row-->
                                        <!--begin::Table row-->
                                        <tr>
                                            ...
                                            <!--end::Badge=-->
                                            <!--begin::Status=-->
                                            <td>POST /v1/customer/c_60f1930ca0d5b/not_found</td>
                                            <!--end::Status=-->
                                            <!--begin::Timestamp=-->
                                            <td class="pe-0 text-end min-w-200px">24 Jun 2021, 11:05 am</td>
                                            <!--end::Timestamp=-->
                                        </tr>
                                        <!--end::Table row-->
                                        <!--begin::Table row-->
                                        <tr>
                                            ...
                                            <!--end::Badge=-->
                                            <!--begin::Status=-->
                                            <td>POST /v1/invoices/in_8151_3511/payment</td>
                                            <!--end::Status=-->
                                            <!--begin::Timestamp=-->
                                            <td class="pe-0 text-end min-w-200px">21 Feb 2021, 10:30 am</td>
                                            <!--end::Timestamp=-->
                                        </tr>
                                        <!--end::Table row-->
                                        <!--begin::Table row-->
                                        <tr>
                                            ...
                                            <!--end::Status=-->
                                            <!--begin::Timestamp=-->
                                            <td class="pe-0 text-end min-w-200px">21 Feb 2021, 10:10 pm</td>
                                            <!--end::Timestamp=-->
                                        </tr>
                                        <!--end::Table row-->
                                        <!--begin::Table row-->
                                        <tr>
                                            ...
                                            <!--end::Status=-->
                                            <!--begin::Timestamp=-->
                                            <td class="pe-0 text-end min-w-200px">25 Jul 2021, 9:23 pm</td>
                                            <!--end::Timestamp=-->
                                        </tr>
                                        <!--end::Table row-->
                                    </tbody>
                            ...
                            <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-bold gy-5" id="kt_table_customers_events">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <!--end::Event=-->
                                        <!--begin::Timestamp=-->
                                        <td class="pe-0 text-gray-600 text-end min-w-200px">10 Mar 2021, 11:05 am</td>
                                        <!--end::Timestamp=-->
                                    </tr>
                                    <!--end::Table row-->
                                    <!--begin::Table row-->
                                    <tr>
                                        ...
                                        <!--end::Event=-->
                                        <!--begin::Timestamp=-->
                                        <td class="pe-0 text-gray-600 text-end min-w-200px">21 Feb 2021, 11:30 am</td>
                                        <!--end::Timestamp=-->
                                    </tr>
                                    <!--end::Table row-->
                                    <!--begin::Table row-->
                                    ...
                                    <tr>
                                        ...
                                        <!--end::Event=-->
                                        <!--begin::Timestamp=-->
                                        <td class="pe-0 text-gray-600 text-end min-w-200px">05 May 2021, 11:30 am</td>
                                        <!--end::Timestamp=-->
                                    </tr>
                                    <!--end::Table row-->
                                    <!--begin::Table row-->
                                    ...
                                    <tr>
                                        ...
                                        <!--end::Event=-->
                                        <!--begin::Timestamp=-->
                                        <td class="pe-0 text-gray-600 text-end min-w-200px">22 Sep 2021, 10:10 pm</td>
                                        <!--end::Timestamp=-->
                                    </tr>
                                    <!--end::Table row-->
                                </tbody>
                ...
                <!--end:::Tab pane-->
                <div class="tab-pane fade" id="kt_user_view_overview_roles_and_permissions" role="tabpanel">
                    <!--begin::Card-->
                    <div class="card pt-4 mb-6 mb-xl-9">
                        <!--begin::Card header-->
                        <div class="card-header border-0">
                        ...
                        <div class="card-body pt-0 pb-5">
                            ...
                            @if (!empty($roles))
                                <form action="{{ route('user.roleAssign', $user->id)}}" method="post">
                                        ...
                                        @foreach ($roles as $role)
                                            ...
                                            <div class="d-flex align-items-center mb-8">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid mx-5">
                                                    <input {{ (!empty($user->getRoleNames()) && in_array($role->name, $user->getRoleNames()->toarray())) ? 'checked' : '' }} class="form-check-input" type="checkbox" name="roles[]" value="{{ $role->name }}" >
                                                </div>
                                                <!--end::Checkbox-->
                                                <!--begin::Description-->
                                                <label class="flex-grow-1">
                                                    <a href="#" class="text-gray-800 text-hover-primary fw-bolder fs-6">{{ $role->name}}</a>
                                    ...
                                    <button class="btn btn-primary" type="submit">Шинэчлэх</button>
