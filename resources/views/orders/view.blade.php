                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                <td class="text-muted">
                                    ...
                                    <!--end::Svg Icon-->Төлбөрийн хэлбэр</div>
                                </td>
                    ...
                    <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td class="fw-bolder text-end">
                                    <a href="/metronic8/demo1/../demo1/apps/invoices/view/invoice-3.html" class="text-gray-600 text-hover-primary">#INV-000414</a>
                                </td>
                            </tr>
                            <!--end::Invoice-->
                            <!--begin::Shipping-->
                            ...
                            <tr>
                                ...
                                <td class="fw-bolder text-end">00021*****54651</td>
                            </tr>
                            <tr>
                                <td class="text-muted">
                                    <div class="d-flex align-items-center">
                                ...
                                <td class="fw-bolder text-end">Байгууллага</td>
                            </tr>
                            <tr>
                                <td class="text-muted">
                                    <div class="d-flex align-items-center">
                                ...
                                <td class="fw-bolder text-end">2061759</td>
                            </tr>
                        </tbody>
                        <!--end::Table body-->
                    </table>
