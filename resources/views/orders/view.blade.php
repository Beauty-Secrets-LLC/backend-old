...
<div class="d-flex flex-column gap-7 gap-lg-10">
    <div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
        ...
        <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-lg-n2 me-auto">
            ...
            <!--begin:::Tab item-->
            <li class="nav-item">
                <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#invoice">Нэхэмжлэл</a>
            </li>
            <!--end:::Tab item-->
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade active show" id="summary" role="tab-panel">
            <div class="d-flex flex-column flex-xl-row gap-7 gap-lg-10 mb-10">
                ...
                @component('components.orders.customer', ['order' => $order]) @endcomponent
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5 mb-0">
                                    ...
                                    <thead>
                                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-70px text-end">Ширхэгийн үнэ</th>
                                            <th class="min-w-100px text-end">Тоо ширхэг</th>
