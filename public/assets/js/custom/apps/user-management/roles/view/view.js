        ...
        o = () => {
            ...
            r.forEach((t) => {
                ...
                c.addEventListener("click", function () {
                    Swal.fire({
                        text: "Сонгогдсон хэрэглэгчдийг хасах уу?",
                        icon: "warning",
                        showCancelButton: !0,
                        buttonsStyling: !1,
                        ...
                        c.value
                            ...
                            : "cancel" === c.dismiss &&
                              Swal.fire({ text: "Устгах үйлдэл цуцлагдлаа", icon: "error", buttonsStyling: !1, confirmButtonText: "За", customClass: { confirmButton: "btn fw-bold btn-primary" } });
                    });
                });
        };
    const n = () => {
            ...
            (e = document.querySelector("#kt_roles_view_table")) &&
                ...
                e.querySelectorAll('[data-kt-roles-table-filter="delete_row"]').forEach((e) => {
                    e.addEventListener("click", function (e) {
                        ...
                        Swal.fire({
                            text: "Та " + n + "-р мөрийн хэрэглэгчийн хасах гэж байна уу?",
                            icon: "warning",
                            showCancelButton: !0,
                            buttonsStyling: !1,
                            confirmButtonText: "Тийм",
                            ...
                            e.value
                                ? Swal.fire({ text: "Хэрэглэгч хасагдлаа!.", icon: "success", buttonsStyling: !1, confirmButtonText: "За", customClass: { confirmButton: "btn fw-bold btn-primary" } }).then(function () {
                                      t.row($(o)).remove().draw();
                                  })
                                : "cancel" === e.dismiss &&
